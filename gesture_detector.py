...
with mp_hands.Hands( 
    ...
    if results.multi_hand_landmarks:
         for handLandmarks in results.multi_hand_landmarks:
             ...
             if not thumbIsOpen and indexIsOpen and middelIsOpen and ringIsOpen and pinkyIsOpen:
                print("FIVE!")

             elif  thumbIsOpen and indexIsOpen and middelIsOpen and ringIsOpen and pinkyIsOpen:
                print("FOUR!")
